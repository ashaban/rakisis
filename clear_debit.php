...
xmlhttp.open("GET","clear_debit_JSP.php?name="+str+"&from=showNames",true);
xmlhttp.send();
}
...
xmlhttp.open("GET","clear_debit_JSP.php?from=check&amount_paid="+document.getElementById(id).value+"&id="+id,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","clear_debit_JSP.php?from=submit&id="+id+"&amount_paid="+document.getElementById(id).value,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","clear_debit_JSP.php?id="+customer_id+"&from=showDebtInfo",true);
xmlhttp.send();
}
...
<tr><td colspan="3" align="center"><h3>LIPA DENI</h3></td></tr>
<tr style='background-color:#C0C0C0;'>
<td><b>Chagua Jina La Anaedai</b></td><td><input type="text" name="names" onkeyup="showNames(this.value)" autocomplete="off" style="width:155"></td>
<td id="button"></td>
</tr>
<tr>
<td>&nbsp;</td>
