...
xmlhttp.open("GET","salesReportJSP.php?from=showReport&item="+item+"&batch="+batch+"&fromdate="+from+"&todate="+to,true);
xmlhttp.send();
}
...
xmlhttp.onreadystatechange=function()
  ...
  var from=document.salereport.from.value;
  var to=document.salereport.to.value;
xmlhttp.open("GET","salesReportJSP.php?from=changeView&item="+item+"&batch="+batch+"&fromdate="+from+"&todate="+to+"&view="+view,true);
xmlhttp.send();
}
}
</script>
