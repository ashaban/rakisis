...
xmlhttp.open("GET","wholeSaleJSP.php?from=showBatch&id="+id+"&branch="+branch,true);
xmlhttp.send();
}
...
var branch=document.sale.branch.value;
xmlhttp.open("GET","wholeSaleJSP.php?from=showDescr&id="+str+"&branch="+branch,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","wholeSaleJSP.php?from=search_customer&search_name="+search_name,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","wholeSaleJSP.php?from=checkQuantity&quantityToCheck="+document.sale.quantity.value+"&batchToCheck="+document.sale.batch.value,true);
xmlhttp.send();
}
...
function check_customer_selection() {
	...
	xmlhttp.open("GET","wholeSaleJSP.php?from=check_customer_selection&mode="+document.sale.mode.value,true);
	xmlhttp.send();
	}
...
var advance_amount=document.sale.advance_amount.value;
var branch=document.sale.branch.value;
xmlhttp.open("GET","wholeSaleJSP.php?from=process_sale&advance_amount="+advance_amount+"&pay_mode="+mode+"&branch="+branch,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","wholeSaleJSP.php?from=display_items_lists",true);
xmlhttp.send();
}
...
xmlhttp.onreadystatechange=function()
 ...
 var branch=document.sale.branch.value;
xmlhttp.open("GET","wholeSaleJSP.php?from=addQue&item="+item+"&batch="+batch+"&quantity="+quantity+"&salePrice="+salePrice+"&date="+date+"&type="+type+"&customer_id="+customer_id+"&invoice_number="+invoice_number+"&branch="+branch,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","wholeSaleJSP.php?from=remove&id="+id,true);
xmlhttp.send();
}
...
var batch=document.sale.batch.value;
xmlhttp.open("GET","wholeSaleJSP.php?from=check_date_validity&sale_date="+sale_date+"&batch="+batch,true);
xmlhttp.send();
}
