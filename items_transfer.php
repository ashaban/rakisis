...
xmlhttp.open("GET","items_transfer_JSP.php?from=show_batches&id="+id,true);
xmlhttp.send();
}
...
function show_batch_descriptions(id) {
	...
	xmlhttp.open("GET","items_transfer_JSP.php?from=show_batch_descriptions&id="+id,true);
	xmlhttp.send();
	}
	...
	function make_transfer() {
		...
		xmlhttp.open("GET","items_transfer_JSP.php?from=make_transfer&batch="+batch+"&quantity="+quantity_transfer+"&branch="+branch+"&date_transfered="+date_transfered,true);
		xmlhttp.send();
	}	
...
<div id="page">
	<!-- start content -->
	<div id="content">
	<div id="infomsg" style="color:black;font-weight:bold;text-align:center"></div>
	<center>
...
?>
</td><td><span id="batches"></span></td><td align='center'>Tarehe Yakuhamisha</td><td><script>DateInput('date_transfered', true, 'YYYY-MM-DD')</script></td></tr></table>
<div id="errmsg" style="color:red;font-weight:bold;text-align:center"></div>
