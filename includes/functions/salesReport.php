...
echo "<tr style='background-color:#515151;color:white;font-family:Georgia, Times New Roman, Times, serif;font-weight:bold;font-size:15;border-color:black'><td colspan='4' align='left'><b>Total Sale=$totalSale</b></td><td colspan='4' align='right'><b>Total Margin=$totalMargin</b></td></tr></table></td>";
$totalMargin=0;
$margin=0;
$totalSale=0;
}
...
{
echo "<td valign='top'><table><tr><td colspan='8' align='center'><b>Retail Sale Report</b></td></tr><tr style='background-color:#515151;color:white;font-family:Georgia, Times New Roman, Times, serif;font-weight:bold;font-size:13;'>";
if($category=="delete")
echo "<th>&nbsp;</th>";
...
$totalSale=number_format($totalSale);
echo "<tr style='background-color:#515151;color:white;font-family:Georgia, Times New Roman, Times, serif;font-weight:bold;font-size:15;border-color:black'><td colspan='4' align='left'><b>Total Sale=$totalSale</b></td><td colspan='4' align='right'><b>Total Margin=$totalMargin</b></td></tr></table></td></tr></table>";
