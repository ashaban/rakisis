...
$results=mysql_query("select * from retailStock where date>='2014-01-01'");
while($row=mysql_fetch_array($results))
{
list($quantity_sold)=mysql_fetch_array(mysql_query("select sum(quantity) from sales where type='retail' and batchNumber='$row[id]'"));
